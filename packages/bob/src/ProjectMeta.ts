...
type ProjectMetaValueSchema = z.ZodObject<{
  config: z.ZodDiscriminatedUnion<string, any> | z.ZodObject<{ [x: string]: z.ZodType<z.Scalars> }> | z.ZodNull;
}>;
...
export function defineProjectMeta<S extends ProjectMetaValueSchema, V extends z.output<S>>(schema: S) {
  return {
